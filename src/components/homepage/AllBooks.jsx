      ...
      <div className="container mx-auto px-6 lg:px-0">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4 font-serif">
            Explore Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400">Library</span>
          </h2>
          <p className="text-white/60 text-lg max-w-2xl mx-auto">
            Discover your next great read from our curated collection of world-class literature across all genres.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {books.map(book => (
            <div 
              key={book.bookId}
              className="group bg-white/5 border border-white/10 rounded-3xl p-6 transition-all duration-500 hover:-translate-y-3 hover:bg-white/[0.08] hover:shadow-2xl hover:shadow-purple-500/10 flex flex-col h-full"
            >
              {/* Image Container */}
                ...
                <div className="mt-auto pt-6 border-t border-dashed border-white/10 flex items-center justify-between text-white/60 font-medium">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.539-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.482-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                    </svg>
                  </div>
                </div>
              </div>
